...
const ProductsDetails = () => {
  ...
  return (
    <div className="p-6">
      <div className="max-w-6xl rounded-lg bg-white p-8 mx-auto">
          ...
          <div className="hidden md:flex flex-col space-y-4 mr-6">
            {selectedProduct.images.map((image, index) => (
              <img
                ...
                alt={image.altText}
                key={index}
                className={`w-20 h-20 obejct-cover rounded-lg cursor-pointer border ${
          ...
          <div className="md:w-1/2 md:ml-10">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center space-x-4 mt-2">
                <button
                  className="px-2 py-1 bg-gray-200 rouned text-lg"
